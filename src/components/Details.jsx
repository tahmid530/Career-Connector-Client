...
const Details = () => {
    ...
    // const remainingData = details.filter(job => job._id === job._id);
    // setDetails(remainingData);
                ...
                <div className="card grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-20 px-6">
                    {/* {
                        jobs.map(job =>  ( */}
                            ...
                            <div key={jobs._id} className="card w-full lg:w-96 border-2 border-black shadow-md mx-auto lg:mx-0">
                                ...
                                <div className="flex justify-center gap-3 pb-5">
                                    <Link to='/apply'><button className="btn btn-outline">Apply</button></Link>
                                </div>
                            </div>
                        {/* ))
                    } */}
